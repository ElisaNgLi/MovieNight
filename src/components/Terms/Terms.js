...
const Terms = () => {
  return (
    <div className="container">
      <Title name="Terms and Condition" />
      <div className="mx-4 mb-4">
        ...
        <p>
          ...
          Terms And Conditiions Sample Generator. <br />
          This Website is a practice website for school purposes.
        </p>
        <br />
        <h6>Intellectual Property Rights</h6>
        <hr />
        <p>
          Other than the content you own, under these Terms, Movie Night and/or
        ...
        <p>
          ...
          and Movie Night may further restrict access by you to any areas of
        ...
        <p>
          ...
          display on this Website. By displaying Your Content, you grant Movie
          Night a non-exclusive, worldwide irrevocable, sub licensable license
          ...
          third-party’s rights. Movie Night reserves the right to remove any of
        ...
        <hr />
        <p>
          This Website is provided "as is," with all faults, and Movie Night
        ...
        <hr />
        <p>
          In no event shall Movie Night, nor any of its officers, directors and
          ...
          under contract. Movie Night, including its officers, directors and
        ...
        <hr />
        <p>
          You hereby indemnify to the fullest extent Movie Night from and
        ...
        <hr />
        <p>
          Movie Night is permitted to revise these Terms at any time as it sees
        ...
        <hr />
        <p>
          The Movie Night is allowed to assign, transfer, and subcontract its
        ...
        <hr />
        <p>
          These Terms constitute the entire agreement between Movie Night and
